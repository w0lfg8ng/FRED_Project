...
class QChart(QtWidgets.QGraphicsWidget):
    ...
    def axes(self, orientation: QtCore.Qt.Orientation = ..., series: typing.Optional[QAbstractSeries] = ...) -> list[QAbstractAxis]: ...
...
class QLegend(QtWidgets.QGraphicsWidget):
    ...
    def markers(self, series: typing.Optional[QAbstractSeries] = ...) -> list[QLegendMarker]: ...
    def labelColor(self) -> QtGui.QColor: ...
    def setLabelColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def labelBrush(self) -> QtGui.QBrush: ...
    def setLabelBrush(self, brush: typing.Union[QtGui.QBrush, typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], QtGui.QGradient]) -> None: ...
...
class QPolarChart(QChart):
    ...
    def axes(self, polarOrientation: 'QPolarChart.PolarOrientation' = ..., series: typing.Optional[QAbstractSeries] = ...) -> list[QAbstractAxis]: ...
